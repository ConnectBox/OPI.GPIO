...
from RPi.constants import HIGH, LOW, IN, OUT, \
...
def PWM_Export(chip, pin):  # some chips will have more than 1 pwm chip. the RPi PC+ only has 1 called pwmchip0. To list what chips are available use 'ls -l /sys/class/pwm'

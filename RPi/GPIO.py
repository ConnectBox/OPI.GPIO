...
RPi.GPIO module allows you to configure the SOC to do this in software:
...
Threaded Callbacks
^^^^^^^^^^^^^^^^^^
RPi.GPIO manages a number of secondary threads for callback functions. This
...
1. First set up RPi.GPIO and create the object
...
however not all pwm pins listed might be readily usable. For example on the RPi PC+ GPIO PA5 (physical pin 7) is listed as being PWM1 however it
...
from RPi.constants import IN, OUT
from RPi.constants import LOW, HIGH                     # noqa: F401
from RPi.constants import NONE, RISING, FALLING, BOTH   # noqa: F401
from RPi.constants import BCM, BOARD, SUNXI, CUSTOM
from RPi.constants import PUD_UP, PUD_DOWN, PUD_OFF     # noqa: F401
from RPi.pin_mappings import get_gpio_pin, set_custom_pin_mappings
from RPi import event, sysfs
